...
export const LoadingTodo = () => {
  return (
    <li className='grid grid-flow-col items-center justify-between bg-primary-light dark:bg-primary-dark px-5 py-3 border-b border-bg-light dark:border-bg-dark'>
